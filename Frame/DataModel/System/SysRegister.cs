...
namespace DataModel
{
    ...
    public partial class SysRegister
    {
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysRegister));
        }
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysRegister), ICrit);
        }
        /// <summary>
        /// 获取行数
        /// </summary>
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysRegister), fileter, objects);
        }

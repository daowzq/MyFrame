// Business class SysOrgGroupOrRole generated from SysOrgGroupOrRole
// Creator: WGM
...
namespace DataModel
{
	[ActiveRecord("SysOrgGroupOrRole")]
	public partial class SysOrgGroupOrRole : ModelBase<SysOrgGroupOrRole>
	{
		...
		public string OrgID
		{
			...
			set
			{
				if ((_orgID == null) || (value == null) || (!value.Equals(_orgID)))
				{
					...
					_orgID = value;
					RaisePropertyChanged(SysOrgGroupOrRole.Prop_OrgID, oldValue, value);
				}
			}
		...
		public string OrgName
		{
			...
			set
			{
				if ((_orgName == null) || (value == null) || (!value.Equals(_orgName)))
				{
					...
					_orgName = value;
					RaisePropertyChanged(SysOrgGroupOrRole.Prop_OrgName, oldValue, value);
				}
			}
		...
		public string GroupOrRoleID
		{
			...
			set
			{
				if ((_groupOrRoleID == null) || (value == null) || (!value.Equals(_groupOrRoleID)))
				{
					...
					RaisePropertyChanged(SysOrgGroupOrRole.Prop_GroupOrRoleID, oldValue, value);
				}
			}
		...
		public string GroupOrRoleName
		{
			...
			set
			{
				if ((_groupOrRoleName == null) || (value == null) || (!value.Equals(_groupOrRoleName)))
				{
					...
					RaisePropertyChanged(SysOrgGroupOrRole.Prop_GroupOrRoleName, oldValue, value);
				}
			}

...
namespace DataModel
{
    ...
    public partial class SysDict
    {
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysDict));
        }
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysDict), ICrit);
        }
        /// <summary>
        /// 获取行数
        /// </summary>
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysDict), fileter, objects);
        }

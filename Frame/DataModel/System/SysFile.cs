...
namespace DataModel
{
    ...
    public partial class SysFile
    {
        ...
        {
            SysFile[] tents = SysFile.FindAll(Expression.In("ID", args));

            foreach (SysFile tent in tents)
            {
                tent.DoDelete();
            }
        }
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysFile));
        }
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysFile), ICrit);
        }
        /// <summary>
        /// 获取行数
        /// </summary>
        ...
        {
            return ActiveRecordMediator.Count(typeof(SysFile), fileter, objects);
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysRole.aspx.cs" Inherits="HDFrame.SysModule.SysRole" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .tab-treebar {
            border-bottom: solid 1px #a1a3a5 !important;
    ...
    <script type="text/javascript">
        ...
        function itemClick(record, item, index) {
            if (record.data.ParentID === "root") {
                App.txtTreeNodeID.setValue(""); //清空TreeNodeId
                ...
                if (Ext.isArray(arr)) {
                    ...
                    //刷新人员,刷新组织
                    if (App.tabPanel.getActiveTab() && App.tabPanel.getActiveTab().id == "UserGrid") {
                        App.UserStore.getProxy().extraParams.PID = record.data.ID;
                        App.UserStore.load();
                    }
                    if (App.tabPanel.getActiveTab() && App.tabPanel.getActiveTab().id == "orgTree") {
                        App.OrgTreeStore.getProxy().extraParams.TreeNodeID = record.data.ID;
                        App.OrgTreeStore.load();
                    }
                }
            }
        }
        ...
        //保存选择的节点
        function saveSelectNode(treePanel, store) {
            ...
            var refID = App.txtTreeNodeID.getValue();
            if (!refID) {
                Ext.Msg.alert("提示", "请选择左侧角色/组节点");
                return;
            }
        ...
        //
        function tabChange(tabPanel, newCard, oldCard, eOpts) {
            // alert(newCard.id);
        }
        //递归选中子节点
...
<body>
    <form id="form1" runat="server">
        <ext:ResourceManager runat="server" ID="ResourceM1" AjaxViewStateMode="Disabled">
        </ext:ResourceManager>
        <ext:Menu runat="server" ID="treeNodeMenu" BodyStyle=" background-color: rgb(231,234,236);">
            <Items>
                <ext:MenuItem ID="MenuItem1" runat="server" Text="添加">
                    <Listeners>
                        <Click Handler="AddNode();"></Click>
                    </Listeners>
                </ext:MenuItem>
                <ext:MenuItem ID="MenuItem2" runat="server" Text="编辑">
                    <Listeners>
                        <Click Handler="editRecord();"></Click>
                    </Listeners>
                </ext:MenuItem>
                <ext:MenuItem ID="MenuItem3" runat="server" Text="删除">
                    <Listeners>
                    ...
                    <Items>
                        ...
                        <ext:Panel ID="Panel3"
                            ...
                            <Items>
                                ...
                                <ext:Label ID="Label1" runat="server" MarginSpec="5 0 0 10" Text="(用于显示顺序排列)"></ext:Label>
                            </Items>
                        </ext:Panel>
                        <ext:Panel ID="Panel2"
                            Layout="BorderLayout"
                            ...
                            <Items>
                                <ext:ComboBox
                                    ...
                                    FieldLabel="类型">
                                    <Items>
                                        <ext:ListItem Text="组" Value="group"></ext:ListItem>
                                        <ext:ListItem Text="角色" Value="role"></ext:ListItem>
                                    </Items>
                                    <SelectedItems>
                                        <ext:ListItem Value="role"></ext:ListItem>
                                    </SelectedItems>
                                </ext:ComboBox>
                                <ext:TextField
                                    Width="170"
            ...
            <Items>
                        ...
                        <ext:TreePanel
                            ...
                            <TopBar>
                                <ext:Toolbar ID="treeTbar"
                                    ...
                                    runat="server">
                                    <Items>
                                        <ext:Button ID="Button2" runat="server" Icon="ApplicationGet" Text="展开/收缩">
                                            <Listeners>
                                        ...
                                        <ext:Label runat="server" Text="(右键编辑)"></ext:Label>
                ...
                <ext:Panel
                    ...
                    <Items>
                        ...
                        <ext:TextField runat="server" Hidden="true" Name="TreeNodeID" ID="txtTreeNodeID"></ext:TextField>
                        <ext:TabPanel
                            ID="tabPanel"
                            runat="server"
                            BodyStyle="background-color:#fff"
                            ...
                            <Items>
                                ...
                                <ext:GridPanel
                                    ...
                                    Frame="false">
                                    <TopBar>
                                        <ext:Toolbar ID="Toolbar2" runat="server" Height="38">
                                            <Items>
                                                <ext:Button ID="Button8" runat="server" Icon="UserAdd" Text="关联人员">
                                                    <Listeners>
                                                ...
                                                <ext:Button ID="Button9" runat="server" Hidden="true" Icon="PageExcel" Text="导出Excel">
                                                    <Listeners>
                                ...
                                <ext:TreePanel
                                    ...
                                    UseArrows="false">
                                    <Store>
                                        <ext:TreeStore ID="OrgTreeStore" AutoLoad="false" runat="server">
                                            <Proxy>
                                                <ext:AjaxProxy Url="?action=orgreader">
                                                    <Reader>
                                                        <ext:JsonReader />
                                                    </Reader>
                                                </ext:AjaxProxy>
                                    ...
                                    <DockedItems>
                                        <ext:Toolbar runat="server" Cls="tab-treebar">
                                            <Items>
                                                <ext:Button ID="Button1" runat="server" Text="保存" Icon="Disk">
                                                    <Listeners>
                                                        <Click Handler="saveSelectNode(#{orgTree},#{OrgTreeStore})"></Click>
                                                    </Listeners>
                                                </ext:Button>
                                            </Items>
                                        </ext:Toolbar>

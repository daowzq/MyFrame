<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysDict.aspx.cs" Inherits="HDFrame.SysModule.SysDict" %>
    ...
    <form id="form1" runat="server">
        ...
        <ext:Window runat="server"
            ...
            <Items>
                <ext:FormPanel ID="NodeForm" runat="server" MarginSpec="10 0 0 0">
                    <Items>
                        <ext:TextField LabelWidth="60" Width="260" runat="server" Name="ID" Hidden="true" />
        ...
        <ext:Viewport ID="Viewport1" runat="server" Cls="west-panel" Layout="BorderLayout">
            <Items>
                ...
                <ext:Panel runat="server" Border="false" Region="North" MarginSpec="3 0 0 0">
                    <Content>
                        <div style="height: 1px; border-top: solid 1px rgb(21,127,204)"></div>
                    </Content>
                </ext:Panel>
                <ext:Panel runat="server" Region="North" Layout="ColumnLayout" MarginSpec="8 0 0 0">
                    <Items>
                        <ext:TextField
                            ColumnWidth="0.25"
                            LabelWidth="60"
                        ...
                        <ext:Panel runat="server" ColumnWidth="0.2">
                            <Items>
                ...
                <ext:TreePanel ID="SysModuleTree"
                            ...
                            <Model>
                                <ext:Model ID="Model1" runat="server" IDProperty="ID">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="Value" Type="Auto" />
                    ...
                    <ColumnModel>
                        <Columns>
                            <ext:Column runat="server" Text="ID" DataIndex="ID" Hidden="true"></ext:Column>

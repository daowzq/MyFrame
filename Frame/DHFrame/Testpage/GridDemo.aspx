        ...
        Ext.onReady(function () {
                ...
                dockedItems: [
            {
                ...
                items: []
            },
                    {
                        ...
                        dock: 'top',
                        items: [{
                            xtype: 'button', icon: "add", text: '新增', minWidth: 85, handler: function () {
            ...
            Ext.define('User', {
                ...
                fields: [
                    ...
                    { name: 'Postion', type: 'string', convert: null },
                    { name: 'CreateTime', type: 'date', convert: null }
                ]
            });
            var data = Ext.decode(pageData.PageData);
            var store = Ext.create('Ext.data.RazorStore', {

...
namespace OpenPop.Pop3
{
	...
	public class Pop3Client : Disposable
	{
		...
		/// 连接到pop服务器
		/// </summary>
		/// <param name="hostname">pop服务器</param>
        /// <param name="port">pop服务器 的端口</param>
		/// <param name="useSsl">是否用ssl协议 </param>
        ...
        /// <param name="hostname">pop服务器</param>
        /// <param name="port">pop服务器 的端口</param>
        /// <param name="useSsl"><see langword="true"/> 是否用ssl协议  <see langword="false"/> if plain TCP should be used.</param>
